 ...
 * @author Allan
 */
public class DetVenta extends javax.swing.JDialog {

    /**
     * Creates new form DetVenta
     */
    public DetVenta(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Resumen Contrato Venta");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DetVenta dialog = new DetVenta(new javax.swing.JFrame(), true);
